        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              // Badges du professionnel
              if (_badgesLoaded && _badges.isNotEmpty)
                _ProfessionalBadgesSection(badges: _badges),
              if (_badgesLoaded && _badges.isNotEmpty)
                const SizedBox(height: 24),

              // Conseils pratiques pour professionnels
              _ProfessionalTipsSection(),
            ],
          ),
        ),
        ),
...
/// Section des badges du professionnel
class _ProfessionalBadgesSection extends StatelessWidget {
  final List<Map<String, dynamic>> badges;

  const _ProfessionalBadgesSection({required this.badges});
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                gradient: LinearGradient(
                  ...
                  colors: [
                    AppTheme.green50,
                    AppTheme.green50.withValues(alpha: 0.7),
                  ],
                ),
                borderRadius: BorderRadius.circular(12),
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: [
                  if (badge['badgeIcon'] != null && badge['badgeIcon'].toString().isNotEmpty) ...[
                    Text(
...
/// Section des conseils pratiques pour professionnels
class _ProfessionalTipsSection extends StatelessWidget {
  final List<Map<String, dynamic>> _tips = [
    {
      'icon': Icons.schedule_rounded,
      'title': 'Gérez vos disponibilités',
      'description': 'Mettez à jour régulièrement vos créneaux disponibles pour maximiser vos réservations.',
      'color': AppTheme.primary,
    },
    {
      'icon': Icons.photo_camera_outlined,
      'title': 'Complétez votre profil',
      'description': 'Une photo professionnelle et un profil détaillé augmentent votre crédibilité.',
      'color': AppTheme.emerald,
    },
    {
      'icon': Icons.notifications_active_rounded,
      'title': 'Activez les notifications',
      'description': 'Restez informé des nouvelles demandes et messages pour répondre rapidement.',
      'color': Colors.orange,
    },
    {
      'icon': Icons.attach_money_rounded,
      'title': 'Tarif compétitif',
      'description': 'Ajustez votre tarif selon votre expérience et le marché local pour rester attractif.',
      'color': AppTheme.error,
    },
  ];
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 16),
        ..._tips.map((tip) => _ProfessionalTipCard(
...
/// Carte de conseil professionnel
class _ProfessionalTipCard extends StatelessWidget {
  final IconData icon;
  final String title;
  final String description;
  final Color color;

  const _ProfessionalTipCard({
    required this.icon,
    required this.title,
