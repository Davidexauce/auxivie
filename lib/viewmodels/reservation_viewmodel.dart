...
class ReservationViewModel extends ChangeNotifier {
  ...
  /// [currentUserId] : ID de l'utilisateur actuel (peut être userId ou professionnelId selon le contexte)
  /// [isProfessional] : true si l'utilisateur actuel est un professionnel
  Future<bool> updateReservation(
    ...
    try {
      ...
      // Recharger les réservations depuis le backend selon le type d'utilisateur
      if (isProfessional) {
