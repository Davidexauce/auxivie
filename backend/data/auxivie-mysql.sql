...
-- Table: reservations (doit être créée avant les tables qui la référencent)
...
CREATE TABLE `reservations` (
  ...
  INDEX `idx_professionnelId` (`professionnelId`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

-- Table: availabilities (référence users)
...
-- Table: documents (référence users)
...
-- Table: messages (référence users)
...
-- Table: payments (référence reservations)
...
-- Table: disputes (référence reservations et users)
...
-- Table: reviews (référence reservations et users)
...
-- Table: user_badges (référence users)
...
-- Table: user_ratings (référence users)
...
-- Table: platform_settings (pas de dépendances)
